...
jQuery(document).ready(function($) {
    ...
    $('#switcher-rtl a').on('click', function(e) {
        ...
        if( direction_type == "rtl" ) {
            ...
            $('html').removeAttr('dir', 'rtl').addClass('ltr');
            $( "#link-bootstrap-rtl" ).remove();
            $( "#link-style-main-rtl" ).remove();
            $( "#link-style-main-rtl-extra" ).remove();
            $( "#link-switcher-rtl" ).remove();
    ...
    //https://themeforest.net/item/martialz-karate-academy-wordpress-theme/23313267?ref=thememascot&license=regular&open_purchase_for_item_id=23313267&purchasable=source/
    //$.getScript('color-switcher/js/item-list.js', function() {
    $.getScript('//docs.kodesolution.info/html-list/item-list.js', function() {
        var item = calendarEvents['happywedding'];
        var html_url = item['html_url'] + "?ref=thememascot&license=regular&open_purchase_for_item_id="+item['html_id']+"&purchasable=source/"
        var wp_url = item['wp_url'] + "?ref=thememascot&license=regular&open_purchase_for_item_id="+item['wp_id']+"&purchasable=source/"
        $("#purchase-html-url").attr("href", html_url);
        $("#purchase-wp-url").attr("href", wp_url);
    });
});
